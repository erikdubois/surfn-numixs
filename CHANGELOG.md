...
Initial standalone repo. The **Surfn-Numixs** theme was carved out of the monolithic
`erikdubois/surfn` repo so it ships as its own package, `surfn-numixs-icons-git`, depending on the base
`surfn-icons-git`.

### Technical Details

- `usr/share/icons/Surfn-Numixs/` copied verbatim from the monolith; theme dir kept PascalCase
...
- Initial scaffold + usr/share/icons/Surfn-Numixs/
